...
<div class="container" style="display: flex">
    <div style="width: 600px" id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100"  src="{{asset('/source/images-shirt/ht5.jpg')}}">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100"  src="{{asset('/source/images-shirt/ht8.jpg')}}">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100"  src="{{asset('/source/images-shirt/ht17.jpg')}}">
        </div>
        </div>
  </div>
  <div style="width: 600px">
      <p>
       ...
       <b> 1. Phải xây dựng được một Style riêng biệt</b><br>
        Một nghiên cứu tại thị trường Hà Nội đã chỉ ra rằng, các shop quần áo có phong cách độc đáo riêng biệt sẽ phát triển bền vững hơn các shop thích gì bán nấy, nay đây mai đó. Lý do bởi: những shop đã tạo nên một style riêng biệt và nhất quán sẽ có một lượng khách hàng trung thành, hay nói chính xác hơn là fan thời trang của shop.
        
        Chắc chắn rằng, mọi sách kinh doanh đều sẽ dạy bạn “muốn phát triển bền vững phải có khách hàng trung thành”.
        
        xây dựng được một style riêng biệt
        ...
        Bạn cũng cần xem xét kĩ lưỡng về các mẫu quần áo mới định nhập, vì nó có thể phá vỡ phong cách đã định hình của cửa hàng bạn.
        
        <br><b>3. Hãy thuê nhân viên có kinh nghiệm</b><br>
