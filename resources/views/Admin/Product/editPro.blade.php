...
<form action="{{$shirt->id_shirt}}" method="post" class="form-horizontal">
        ...
        <div style="display: flex;width: 544px;" class="form-group">
            ...
            <div>
                ...
                <input name="seri" type="" class="form-control" value="{{$shirt->seri}}">
            </div>
        </div>
        ...
        <div class="form-group">
            <label class="control-label col-sm-4" >Tên áo:</label>
             <input name="tenao" type="text" value="{{$shirt->name}}" class="form-control"   placeholder="Tên áo...">       
      </div>
      <div class="form-group">
      ...
      <textarea name="mota" value="{{$shirt->description}}" class="form-control"   placeholder="Mô tả về áo..."></textarea>       
      </div>
      ...
      <input name="gianhap" type="text" value="{{$shirt->price_input}}" class="form-control"   placeholder="Giá nhập của áo..."></input>       
      </div>
      <div class="form-group">
        <label class="control-label col-sm-4" >Giá bán:</label>
        <input name="giaban" type="" value="{{$shirt->price_sell}}" class="form-control"   placeholder="Giá nhập của áo...">     
      </div>
      <div class="form-group">
