...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      <div class="container">
        <div class="row">
          <h2 class="col-sm-8">DANH SÁCH ĐƠN HÀNG ĐANG GỬI</h2>
          ...
          <tbody>
            ...
            <td>{{$r->phone}}</td>
              ...
              <td>Đang gửi</td>
                ...
                <td><a onclick="return confirm('Bạn có chắc đơn hàng này đã thanh toán?')" href="shiping_to_paymented/{{$r->id_order}}" style="color: green; font-size:26px;" class="fa fa-arrow-right"
                  aria-hidden="true"></a>
                </td>
                <td>
