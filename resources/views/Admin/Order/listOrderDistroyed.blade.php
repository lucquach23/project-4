...
<div class="col-md-12 col-sm-12 ">
  <div class="x_panel">
    <div class="x_title">
      <div class="container">
        <div class="row">
          <h2 class="col-sm-8">DANH SÁCH ĐƠN HÀNG ĐÃ HUỶ</h2>
        ...
        <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action" style="width:100%">
          ...
          <tbody>
            ...
            <td>Đã huỷ</td>
            <td>
              <a onclick="return confirm('Bạn có chắc chắn muốn khôi phục đơn hàng này?')" href="re-order/{{$r->id_order}}" style="color:green; font-size:26px;" class="fa fa-arrow-left"
                aria-hidden="true">
              </a>
            </td>
